...
8. run "python 1 comment_parser.py comment.html share.json status.json" to generate "data.tsv", "barData.tsv" and "page2.json". Change the "1" to "2" for Chinese subjects.