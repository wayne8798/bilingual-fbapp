...
"어제는 당신의 생일이었고 많은 사람들이 페이스북에 축하글을 남겼습니다.<br> 생일 축하글을 남긴 사람들에게 감사글을 포스팅해주세요."];
...
"临近毕业，你正准备卖掉你自己的车（Ford Fusion，2009，蓝色，35000英里），<br> 并标价10000美元。请发表一个和配图相关的广告贴。",
"今天是圣诞节。请发表一个状态祝你的朋友们圣诞快乐。",
"你刚刚去纽约市玩了三天。这趟旅行中你参观了自由女神像，华尔街金牛，并且在时代广场拍了一张照（下图）。请发表一条关于这张照片的状态。",
...
if (L1.indexOf("Korean") > -1)
	...
	document.getElementById("L1").nextSibling.nodeValue = "Chinese";
	}
}
